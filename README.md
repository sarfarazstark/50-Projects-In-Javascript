...
<body>
 <table>
    ...
    <tbody>
        <tr>
            <td>01</td>
            <td><picture><source srcset="./svg/dark-checked.svg" media="(prefers-color-scheme: dark)"><img src="./svg/checked.svg" alt="Adaptive Image"></picture></td>
        ...
        <tr>
            <td>04</td>
            <td><picture><source srcset="./svg/dark-uncheck.svg" media="(prefers-color-scheme: dark)"><img src="./svg/uncheck.svg" alt="Adaptive Image"></picture></td>
